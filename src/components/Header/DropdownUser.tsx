  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      {session?.user ? (
        ...
        <Link
          href="/auth/signin"
          className="relative z-10 flex h-12  w-[96px] cursor-pointer items-center justify-center gap-2.5 rounded-full bg-gray-3 p-[5px] text-dark dark:bg-[#020d1a] dark:text-white"
        >
          Login
        </Link>
      )}
